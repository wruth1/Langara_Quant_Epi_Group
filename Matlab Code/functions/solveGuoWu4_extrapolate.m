function [XELTR, TBIncidence, TBPrevalence] = solveGuoWu4_extrapolate(bioParameters, initialConditions, ImmigrationRate,qvec_t)
%{
Updated to include sigma, the reactivation rate of R to T
  Input: 
    - bioParameters vector in R9, hard coded so position [beta p w v a d n sigma]
...
%% Unpack parameters
 ...
 u = bioParameters(8); % aka sigma, percentage people in R develop active TB 
