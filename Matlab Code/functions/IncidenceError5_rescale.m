function err = IncidenceError5_rescale(y, allParams, initalScales, ImmigrationRate, ReportedIncidence)
...
err = IncidenceError5(x, localparams, ImmigrationRate, ReportedIncidence);
