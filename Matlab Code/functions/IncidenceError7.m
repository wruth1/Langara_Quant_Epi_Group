function err = IncidenceError7(x, allParams, ImmigrationRate, ReportedIncidence, ReportedPrevalence)
...
% err = err_Incidence;
    ...
    err_prevalence = error_Prevalence(XELTR, ReportedPrevalence);
    
err = err_Incidence + err_Relapse + err_Relapse0 + err_E2021ratio + err_JordanX0 + err_prevalence;
