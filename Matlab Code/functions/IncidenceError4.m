function err = IncidenceError4(x, bioParameters, ImmigrationRate, ReportedIncidence)
...
% % scalar
    ...
    err_Relapse = error_PR(XELTR, localBP, power_relapse*2);
    
    % err_Relapse0 = error_PR(localIC, localBP, power_relapse);
    err_Relapse0 = 0;

err = err_Incidence + err_Relapse + err_Relapse0;
