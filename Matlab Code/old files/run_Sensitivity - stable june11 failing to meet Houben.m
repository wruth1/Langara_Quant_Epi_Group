...
for i = 1:NumSims
    ...
    % % impose bounds based on Houben
    % Houben_low = 17.28/100;
    % Houben_high = 28.60/100;
    % A(1,1:3) = [1 1 1]; % q1+q2+q3 <= Houben_high
    % b(1) = Houben_high ;
    % A(2,1:3) = [-1 -1 -1]; % q1+q2+q3 <= 100%
    % b(2) = -Houben_low ;
    % %q1 fixed
    % Aeq(3,1:numx) = [1 0 0 0 0 0 0 0 0];
    % beq(3) = [paramsi(9)];
    ...
    x0 = [BPi(9) BPi(10) BPi(11) BPi(8), localIC]; %q1 q2 q3
    % x0 = [x0, localIC]; 
