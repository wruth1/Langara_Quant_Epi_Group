...
% row2 is E0 + L0 + R0 <= TP0 - X0 - T0
    ...
    f7=@(x)IncidenceError7_SS(x,BPi, localIC, ReportedImmigration, ReportedTB);
...
function err = IncidenceError7_SS(x, bioParameters, initialConditions, ImmigrationRate, ReportedTB)
