function [XELTR, TBIncidence] = solveGuoWu(bioParameters, initialConditions, ImmigrationRate)
%{
  Input: 
    - bioParameters vector in R9, hard coded so position [beta p w v a d n q1 q2]
    - initialConditions vector in R5, hard coded so position [TP0 E0 L0 T0
    R0]. TP0 is total population, and used to calculate X0
